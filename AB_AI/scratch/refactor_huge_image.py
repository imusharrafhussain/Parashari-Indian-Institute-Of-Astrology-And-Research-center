...
new_css_block = '''        /* Static Centered Image and Glass Value Card CSS */
        @media (min-width: 992px) {
            .cc-palmistry-landing .wyg-grid {
                grid-template-columns: 1.6fr 1fr !important; /* Aggressively forces the image area to be massive */
                gap: 5rem;
            }
        }
        .cc-palmistry-landing .wyg-img-wrap {
            ...
            position: relative;
            transform: scale(1.18); /* Extensively zooms the component */
        ...
        .cc-palmistry-landing .glass-value-card {
            ...
            width: 100%;
            max-width: 380px; /* Increased massively */
            z-index: 10;
        }
