...
# Previous replacement string to search for
search_str = '''<div class="expert-img-wrap" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
...
# New text-based glowing replacement string
