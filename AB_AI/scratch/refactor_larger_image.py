...
new_css_block = '''        /* Static Centered Image and Glass Value Card CSS */
        @media (min-width: 992px) {
            .cc-palmistry-landing .wyg-grid {
                grid-template-columns: 1.35fr 1fr !important; /* Forces the image column to be much larger natively */
                gap: 4rem;
            }
        }
        .cc-palmistry-landing .wyg-img-wrap {
            ...
            position: relative;
            transform: scale(1.08); /* Natural gentle zoom */
        ...
        .cc-palmistry-landing .glass-value-card {
            ...
            width: 100%;
            max-width: 360px; /* Increased to match larger image */
            z-index: 10;
        }
...
for filepath in files:
    ...
    pattern = r'/\*\s*Static Centered Image and Glass Value Card CSS\s*\*/.*?((?=\/\*\s*Nuke horizontal sliders)|</style>)'
