...
clean_wyg_js = """var items = [
    ...
    {icon:"🎁",title:"Bonus Material",desc:"Exclusive techniques not available publicly",value: "<span class='wyg-inc'>Included</span>"},
        ...
        if os.path.exists(filepath):
            ...
            if re.search(pattern, content, flags=re.DOTALL):
                ...
                with open(filepath, 'w', encoding='utf-8') as f:
                    f.write(new_content)
                print(f"Cleaned WYG explicitly: {filename}")
