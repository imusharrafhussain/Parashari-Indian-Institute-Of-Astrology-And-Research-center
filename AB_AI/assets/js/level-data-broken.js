...
const COURSE_REGISTRY = {
  ...
  "kp-astrology":         { name: "KP Astrology",          file: "kp-astrology.html",        image: "KP.webp" },
        ...
        <section class="cvd-hero">
          <div class="cvd-hero-container">
            <div class="cvd-hero-text">
              ...
              <div class="cvd-hero-title">Master Vedic Astrology:</div>
              ...
              <a href="register.html" class="cvd-hero-btn">Enroll Now - ₹4199</a>
              <div class="cvd-hero-save"><i class="fas fa-check" style="color: #6B8E23;"></i> Save 24% Today &nbsp;&middot;&nbsp; Duration: 8 Weeks</div>
              
              <div style="margin-top: 25px;">
                <a href="astrology.html" style="color: #B27C31; font-weight: 600; text-decoration: underline; font-size: 1rem;">
    ...
    <div class="cvd-strip">
      <div class="cvd-strip-inner">
        <div class="cvd-strip-text">
          Limited Offer: Only ₹4,199 
          <span style="font-size:1.1rem; color:#444; font-weight:normal; display:block; margin-top:5px;">(Save ₹1300 &ndash; Regular Price ₹5,499)</span>
        </div>
        <div>
          <a href="register.html" class="cvd-strip-btn"><i class="far fa-file-alt"></i> Get Started Now!</a>
          <a href="astrology.html" class="cvd-strip-link">For price comparison follow this</a>
        </div>
      </div>
    </div>
    ...
    <section class="cvd-section">
      <div class="cvd-faq">
        <div class="cvd-faq-item">
          ...
          <div class="cvd-faq-answer">Yes, absolutely! The ${levelLabel} course is specifically structured to take you from knowing absolutely nothing about astrology to being able to read and understand foundational birth charts. All concepts are broken down into simple, digestible lessons.</div>
        </div>
        <div class="cvd-faq-item">
          ...
          <div class="cvd-faq-answer">Even without an exact birth time, you can learn planetary positioning based on the Moon sign (Chandra Kundli) which gives highly accurate insights. Later in advanced modules, you will learn basic birth time rectification principles.</div>
        </div>
        <div class="cvd-faq-item">
          ...
          <div class="cvd-faq-answer">Yes, upon completion of the 8-week ${levelLabel} and passing the final assessment, you will receive a Government Approved, ISO Certified ${levelLabel} in Vedic Astrology from the Parashari Indian Institute.</div>
        </div>
        <div class="cvd-faq-item">
          <div class="cvd-faq-question" onclick="this.parentElement.classList.toggle('active')">How long will I have access to the materials? <span class="cvd-faq-icon">+</span></div>
          <div class="cvd-faq-answer">Your access to the course portal, video lessons, and PDF materials is valid for the 8-week duration of the course. This encourages you to stay focused and complete your certification on time.</div>
        </div>
      </div>
    </section>
  `;
